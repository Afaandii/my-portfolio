  ...
  return (
    <section id="skills" className="section" ref={sectionRef}>
      <div className="container">
        ...
        <p className="text-center text-lg font-medium text-muted mb-6">
          Tech Stack I Love
        </p>
        ...
        <div>
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-6 justify-center">
            {[
              {
                n: "JavaScript",
                e: <SiJavascript className="w-full h-full" />,
              },
              {
                n: "TypeScript",
                e: <SiTypescript className="w-full h-full" />,
              },
              ...
              {
                n: "CodeIgniter",
                e: <SiCodeigniter className="w-full h-full" />,
              },
              ...
              {
                n: "PostgreSQL",
                e: <SiPostgresql className="w-full h-full" />,
              },
