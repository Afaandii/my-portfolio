    ...
    <footer className="py-12 border-t border-border mt-auto">
      <div className="container">
        ...
        <div className="flex flex-col items-center gap-6 text-center">
          {/* Uptime Status */}
          <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-surface/50 border border-border/50 text-xs font-medium text-emerald-500">
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-2 text-sm text-muted">
            ...
            <span className="flex items-center gap-1">
              Made with <span className="text-red-500">❤️</span> & lots of ☕
            </span>
            <span className="hidden sm:inline text-border">|</span>
