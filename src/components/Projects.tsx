  ...
  return (
    <section id="projects" className="section bg-surface/50">
      <div className="container">
        ...
        <p className="section-subtitle">Showcase of my recent work and side projects</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, i) => (
            ...
            >
              {/* Project Image Area */}
              <div className="aspect-video relative overflow-hidden bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10">
                {/* Icon */}
                ...
                <div className="absolute inset-0 bg-background/80 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center gap-3">
                  <a 
                    ...
                    className="px-5 py-2.5 rounded-lg bg-gradient-to-r from-primary to-secondary text-white text-sm font-medium hover:shadow-lg transition-all hover:-translate-y-0.5"
                  >
                    Live Demo
                  </a>
                  <a 
